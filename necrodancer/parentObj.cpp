...
//string parentObj::makeSaveInfo()
//{
//	string data;
//	data.clear();
//
//	data.append(_imgName);
//	data.append(",");
//	data.append(makeString(_objType));
//	data.append(",");
//	data.append(makeString(_pos.x));
//	data.append(",");
//	data.append(makeString(_pos.y));
//	data.append(",");
//	data.append(makeString(_rc.right));
//	data.append(",");
//	data.append(makeString(_rc.left));
//	data.append(",");
//	data.append(makeString(_rc.top));
//	data.append(",");
//	data.append(makeString(_rc.bottom));
//	data.append(",");
//	data.append(makeString(_frameX));
//	data.append(",");
//	data.append(makeString(_frameY));
//	data.append(",");
//
//
//	return string();
//}
//
//void parentObj::loadSaveInfo(string * data)
//{
//
//}
//
